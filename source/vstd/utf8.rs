...
/// per-`char` byte-offset lemma - see [`lemma_encode_utf8_concat`].
...
/// Convenience form of [`lemma_encode_utf8_concat`] for the common case
...
/// to re-derive it from [`lemma_encode_utf8_concat`] by hand each time.
